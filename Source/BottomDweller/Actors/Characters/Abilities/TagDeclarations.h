...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Tag_Gameplay_Dead)
...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Tag_Attribute_SlashingDamageResistance)
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Tag_Attribute_BluntDamageResistance)
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Tag_Attribute_PiercingDamageResistance)
